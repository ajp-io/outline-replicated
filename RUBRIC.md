...
| Slack integration — link unfurling | 1 | Paste an Outline document URL into Slack and show it rendering as a rich preview with the document title and excerpt. | Same Slack workspace as above. |
